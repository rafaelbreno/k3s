...
require (
	...
	k8s.io/endpointslice v0.33.12 // indirect
	k8s.io/externaljwt v1.33.9 // indirect
	k8s.io/kms v0.34.5 // indirect
	k8s.io/kube-aggregator v0.34.1 // indirect
	k8s.io/kube-controller-manager v0.33.12 // indirect
	k8s.io/kube-openapi v0.0.0-20250910181357-589584f1c912 // indirect
	k8s.io/kube-scheduler v0.33.12 // indirect
	k8s.io/metrics v0.33.12 // indirect
